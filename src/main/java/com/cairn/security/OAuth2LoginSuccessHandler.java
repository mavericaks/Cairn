...
/**
 * WHY: Intercepts successful GitHub logins. Creates or updates the User in the DB,
 * generates a JWT, and redirects the client with the token so it can be used for API requests.
 */
@Component
